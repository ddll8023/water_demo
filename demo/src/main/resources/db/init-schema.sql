...
CREATE TABLE IF NOT EXISTS `departments` (
  ...
  `is_active` boolean DEFAULT TRUE COMMENT '部门是否启用',
  `created_at` datetime NOT NULL COMMENT '创建时间',
  `updated_at` datetime NOT NULL COMMENT '更新时间',
  `deleted_at` datetime DEFAULT NULL COMMENT '软删除标记',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `personnel` (
  ...
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '在职' COMMENT '状态 (在职/离职/休假)',
...
CREATE TABLE IF NOT EXISTS `pumping_stations` (
  ...
  `station_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '泵站类型（关联dict_data.data_value，type_code=facility_type）',
...
CREATE TABLE IF NOT EXISTS `pipelines` (
  ...
  `material` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '管道材质（关联dict_data.data_value，type_code=pipeline_material）',
  ...
  `operation_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '运行状态（关联dict_data.data_value，type_code=operation_status）',
...
CREATE TABLE IF NOT EXISTS `inspection_tasks` (
  ...
  `facility_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设施类型（dict_data.data_value，type_code=facility_type）',
